...
for key, metric_types in list_metrics.items(): 
    ...
    fig.tight_layout()
    plt.show()
    plt.savefig('/home/ec3731/issa_analysis/nn-analysis/all_features_v2_{}.png'.format(key))
    plt.savefig('/mnt/smb/locker/issa-locker/users/Eugénie/nn-analysis/straightening/all_features_v2_{}.png'.format(key))
