...
for key, metric_types in list_metrics.items(): 
    ...
    for i, metric_type in enumerate(metric_types):
        ...
        axes[0,i].axvline(x = 3, color = 'grey', alpha = 0.5, ls = '-')
        axes[0,i].axvline(x = 6, color = 'grey', alpha = 0.5, ls = '-')
        axes[0,i].axvline(x = 10, color = 'grey', alpha = 0.5, ls = '-')
        axes[0,i].axvline(x = 16, color = 'grey', alpha = 0.5, ls = '-')
        axes[0,i].axvline(x = 19, color = 'grey', alpha = 0.5, ls = '-')
        axes[0,i].axvline(x = 20, color = 'grey', alpha = 0.5, ls = '-')
