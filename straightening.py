...
for key, metric_types in list_metrics.items(): 
    ...
    for i, metric_type in enumerate(metric_types):
        ...
        axes[0,i].axvline(x = 3, color = 'b')
        axes[0,i].axvline(x = 6, color = 'b')
        axes[0,i].axvline(x = 10, color = 'b')
        axes[0,i].axvline(x = 16, color = 'b')
        axes[0,i].axvline(x = 19, color = 'b')
        axes[0,i].axvline(x = 20, color = 'b')
