...
for key, metric_types in list_metrics.items(): 
    ...
    for i, metric_type in enumerate(metric_types):
        ...
        axes[0,i].text(5, 0.2, "Block V1", ha="center", va="center", size=12)
        axes[0,i].text(9, 0.2, "Block V2", ha="center", va="center", size=12)
        axes[0,i].text(15, 0.2, "Block V4", ha="center", va="center", size=12)
        axes[0,i].text(18, 0.2, "Block IT", ha="center", va="center", size=12)
