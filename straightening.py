...
metric_types = ['x_cam_pan-detailed', 'x_cam_pan', 'yz_cam_pan-detailed',
...
fig.tight_layout()
plt.show()
plt.savefig('/mnt/smb/locker/issa-locker/users/Eugénie/nn-analysis/straightening/FINAL_inj_vs_control_focuspan.png')
