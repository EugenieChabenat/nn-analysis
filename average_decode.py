...
plt.show()
plt.savefig('/mnt/smb/locker/issa-locker/users/Eugénie/nn-analysis/decode/avg-decode-all1.png')
plt.savefig('/home/ec3731/issa_analysis/nn-analysis/avg-decode-all2.png')
