...
plt.show()
plt.savefig('/mnt/smb/locker/issa-locker/users/Eugénie/nn-analysis/decode/avg-decode-np-v2.png')
plt.savefig('/home/ec3731/issa_analysis/nn-analysis/avg-decode-np-v2.png')
