...
fig.suptitle('Comparison in factorization performance between injection V4 models and control (no injection) at injection site', fontweight='bold')
fig.tight_layout()

pt.round_plot.savefig(fig, '/home/ec3731/issa_analysis/nn-analysis/factpervv4.png')
