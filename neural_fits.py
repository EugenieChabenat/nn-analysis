...
for i, metric_type in enumerate(metric_types):
    ...
    axes[0,i].text(7.5, 0.15, "Block V1", ha="center", va="center", size=14)#, size=60)
    axes[0,i].text(13, 0.15, "Block V2", ha="center", va="center", size=14)#, size=60)
    axes[0,i].text(18, 0.15, "Block V4", ha="center", va="center", size=14)#, size=60)
...
fig.tight_layout()
plt.show()
plt.savefig('/home/ec3731/issa_analysis/nn-analysis/neuralfits_all_layers_it8.png')
