...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', default = "resnet50_untrained_bootstrap", type=str,
    ...
    parser.add_argument('--acts_name', default = "pseudo_hvm_factorize_obj_motion", type=str,
