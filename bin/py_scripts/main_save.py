...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', default = "multiplicative_unfreeze_v2", type=str,
    ...
    parser.add_argument('--acts_name', default = "pseudo_hvm_background_obj_motion", type=str,
