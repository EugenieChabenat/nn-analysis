...
for key, metric_types in list_metrics.items(): 
    ...
    for i, metric_type in enumerate(metric_types):
        ...
        axes[key,i].text(13, 0.95, "Block V4", ha="center", va="center", size=12)#, size=60)
        axes[key,i].text(17.5, 0.95, "Block IT", ha="center", va="center", size=12)#, size=60)
...
fig.tight_layout()
plt.show()
plt.savefig('/home/ec3731/issa_analysis/nn-analysis/15thesis-v1_decode_{}.png'.format(key))
