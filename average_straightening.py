...
plt.show()
plt.savefig('/mnt/smb/locker/issa-locker/users/Eugénie/nn-analysis/avg-curve-v4_pres.png')
plt.savefig('/home/ec3731/issa_analysis/nn-analysis/1-avg-curve-v4_pres.png')
